...
const BrandForm = () => {
	...
	const schemaModel = yup.object().shape({
		...
		slogan: yup.string().required("This field has to be filled"),
		about: yup.string().required("This field has to be filled"),
		account: yup.string().required("This field has to be filled"),
	});
	...
	const onSubmit = handleSubmit(async (data) => {
		console.log(data);
		const url = `https://project-comsol.herokuapp.com/api/brand/${id}/create`;

		const { name, account, slogan, about } = data;
		...
		<Container>
			<Wrapper>
				<Content>
					<Holder>
						<HolderCard>
							<Welcome>Create a Brand Message</Welcome>
							...
							<Form onSubmit={onSubmit} type="multipart/form-data">
								<ImageHolder>
									...
									<ImageLabel htmlFor="img">
										Choose a cover image for your NGO
									</ImageLabel>
								</ImageHolder>

								<Label>What's your NGO's Name</Label>
								<LabelError>{errors.name && errors?.name.message}</LabelError>
								<Input
									placeholder="What's your NGO's Name"
									{...register("name")}
								/>

								<Label>What's the Slogan for your NGO </Label>
								<LabelError>
									{errors.slogan && errors?.slogan.message}
								</LabelError>
								<Input
									placeholder="What's the Slogan for your NGO"
									{...register("slogan")}
								/>

								<Label>say something about your NGO </Label>
								<LabelError>{errors.about && errors?.about.message}</LabelError>
								<InputArea
									placeholder="say something about your NGO"
									{...register("about")}
								/>

								<Label>Account Number for your NGO </Label>
								<LabelError>
									{errors.account && errors?.account.message}
								</LabelError>
								<Input
									placeholder="Account Number for your NGO"
									{...register("account")}
								/>
